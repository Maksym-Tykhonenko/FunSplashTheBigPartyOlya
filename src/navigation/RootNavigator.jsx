...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://clean-stream-lab.site/`;
  const URL_IDENTIFAIRE = `lEbkIYsx`;
  ...
  OneSignal.initialize('c98c65d8-6bcb-4b55-bd89-6f42782133fe');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-09T08:08:00'); //дата з якої поч працювати webView
